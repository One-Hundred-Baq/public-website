// One Hundred — rule-based chat engine. This is the real, working demo
// (not a placeholder): keyword-matched answers pulled from
// Brand/01-BrandStrategy.md and OneHundred-Workspace evidence.
// To upgrade to a live LLM: set the chat endpoint (see ChatPanel.tsx) —
// nothing here needs to change, it's already the automatic fallback.
...
export function getRuleBasedReply(message: string, lang: Lang): string {
